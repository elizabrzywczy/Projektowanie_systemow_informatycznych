...
# 5.4. Prosty wykres słupkowy: liczba krajów w regionach ----
...
# 5.5. Zaawansowany wykres słupkowy poziomy: TOP 15 najbogatszych krajów ----
kraje %>%
  arrange(desc(PKB_per_capita)) %>%
  head(15) %>%
...
# 5.6. Wykres pudełkowy (boxplot): dostęp do internetu według regionów ----
...
# 5.7. Wykres pudełkowy (boxplot): przyrost populacji według regionów ----
